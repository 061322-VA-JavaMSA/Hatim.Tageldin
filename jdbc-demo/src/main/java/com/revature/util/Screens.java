...
public class Screens {
	...
	public static void welcomeScreen() throws LoginException {
	...
	public static void loginScreen() throws IOException, LoginException{
		System.out.println(breaker);
	...
	public static void registerScreen() throws IOException, LoginException{
		System.out.println(breaker);
