...
public class UserScreens {
	...
	public static void customerScreen(User u) throws SQLException, IOException, LoginException {
	...
	public static void employeeScreen(User u) throws SQLException, IOException, LoginException {
